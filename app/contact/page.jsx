          ...
          <div className="xl:w-[65%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/65">
                ...
                Suscipit magnam inventore veritatis cupiditate quibusdam
                molestias ipsam? Ducimus debitis voluptatum aspernatur, nulla
                dolor consequuntur ut. Enim minus deserunt porro itaque
                molestias.
              </p>
              {/* input */}
